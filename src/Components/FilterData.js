...
export const FilterData = ({itemStore, setItems}) => {
    ...
    return(
        <List >
            <h2 style={{color:'black',fontWeight:"bold"}}>Colour</h2>
            <ListItem >
            ...
            <h2 style={{color:'black',fontWeight:"bold"}}>Gender</h2>
            <ListItem>
            ...
            <h2 style={{color:'black',fontWeight:"bold"}}>Price</h2>
            <ListItem>
            ...
            <h2 style={{color:'black',fontWeight:"bold"}}>Type</h2>
            <ListItem>
